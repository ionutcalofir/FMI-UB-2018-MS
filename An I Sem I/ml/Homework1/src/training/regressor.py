...
class Regressor(BaseTrainer):
    ...
    def _build_train(self, data_path):
        ...
        self._y_train_cls, self._y_test_cls, self._X_fields_dict, self._X_fields_type = \
            self._data.get_data_regression(self._data.get_dataset.values)
    ...
    def predict_test(self, verbose=False):
        ...
        if verbose:
            ...
            print('Explained Variance:', explained_variance_score(self._y_test, y_pred))
